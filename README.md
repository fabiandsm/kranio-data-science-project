...
Proyecto end-to-end de **Data Science + Data Engineering** que simula, procesa y predice ventas futuras de clientes retail mediante un pipeline reproducible.

Este proyecto demuestra construcción de pipelines reales utilizados en entornos productivos.
...
Proyecto desarrollado como parte del portafolio profesional en transición hacia roles de:
